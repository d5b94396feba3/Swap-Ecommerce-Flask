...
from .models import Category,Addproduct,Apparel
...
def get_apparels(id):
	...
	return render_template('products/index.html',apparel=apparel,apparels=apparels(),
		categories=categories(),apparel_pages=apparel_pages)
...
def get_categories(id):
	...
	return render_template('products/index.html',category_pages=category_pages,
		categories=categories(),apparels=apparels(),category=category)
...
def update_product(id):
	...
	return render_template('products/update_product.html',form=form,apparels=apparels,
